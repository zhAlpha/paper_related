 ...
 * 致命信息输出 error
 */
static void error(const char* msg)                                                  //error
{
    fprintf(stderr,"%s\n",msg);
    exit(EXIT_FAILURE);
}
 ...
 */
static int is_assigned(struct arguments * arg, const char* name)
{
    int i;
 ...
 */
static char * get_str(struct arguments * arg, const char * name)
{
    int i;
 ...
 */
static int get_int(struct arguments * arg, const char * name)
{
    int i;
 ...
 */
static double get_double(struct arguments * arg, const char* name)
{
    int i;
 ...
 */
static double * read_pgm_image_double(int * X, int * Y, const char * name)
{
    FILE * f;
    int c,bin;
 ...
 */
static void write_pgm_image_int(int * image, int xsize, int ysize, const char * name)
{
    FILE * f;
    int x,y,n,v,max,min;
...
static void write_eps( double * segs, int n, int dim,
                       const char * filename, int xsize, int ysize, double width )
{
    FILE * eps;
    int i;
